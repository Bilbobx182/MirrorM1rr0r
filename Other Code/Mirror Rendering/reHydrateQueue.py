...
while rehydrateCount < 100:
    ...
    url = "https://tj5ur8uafi.execute-api.us-west-2.amazonaws.com/Prod/sendmessagetoqueue?queueurl=https://sqs.eu-west-1.amazonaws.com/186314837751/ciaranVis.fifo&message=hi"
    lm_json = requests.get(url)